...
import { OrbitControls as ThreeOrbitControls } from "https://cdn.jsdelivr.net/npm/three@0.112.1/examples/jsm/controls/OrbitControls.js";
...
export class OrbitControls {
  ...
  _Init(params) {
    this._controls = new ThreeOrbitControls(params.camera, params.domElement);
